...
my $filenameUsersPerun = "$workDir/users.json";
my $filenamePhotosPerun = "$workDir/photos.csv";
...
$headers->authorization(`cat $accessToken/o365-access-token`);
